                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{route('admin.users.index')}}">Todos Los Empleados</a>
                            </li>

                            <li>
                                <a href="{{route('admin.users.create')}}">Crear Empleado</a>
                            </li>
...
<!-- Page Content -->
<div style="background-color: darkorange" id="page-wrapper">
